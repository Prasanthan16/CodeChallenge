...
export class CommonFormComponet implements OnInit{
    ...
    ngOnInit(): void{
            ...
            if(this.formLable === FORM_TYPE.SIGN_IN){
                this.commonFormGroup.addControl("userName",new FormControl(null, Validators.compose([Validators.required, Validators.maxLength(56), EmailValidator])));
                ...
                this.commonFormGroup.addControl("userName",new FormControl(null, Validators.compose([Validators.required, Validators.maxLength(56)])));
